...
class Baseline(nn.Module):
    ...
    def forward(self, batched_inputs):
        ...
        if self.training:
            ...
            #labels = batched_inputs['view_label']
            #
            view_output = self.backbone(images)[1]
#            view_loss = cross_entropy_loss(view_output, labels, eps = 0.1)
            #
