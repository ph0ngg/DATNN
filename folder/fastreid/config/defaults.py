...
_C.MODEL.FREEZE_LAYERS =[]# ['backbone.conv1', 'backbone.view_predictor1', 'backbone.view_predictor2', 'backbone.view_predictor3', 'backbone.view_predictor4', 'backbone.view_predictor5', 'backbone.bn1', 'backbone.bn2']
...
# Number of identity
_C.MODEL.HEADS.NUM_CLASSES = 1501      
# Embedding dimension in head
_C.MODEL.HEADS.EMBEDDING_DIM = 1536
